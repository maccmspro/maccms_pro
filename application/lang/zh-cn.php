...
https://www.baidu.com/123.jpg
    ...
    'admin/public/head/title'=>'安全第一请勿泄露后台地址 - Copyright by MacCMS Pro',
    'admin/public/jump/title'=>'跳转提示',

    'admin/index/login/title'=>'后台管理中心 - Copyright by MacCMS Pro',
    'admin/index/login/tip_welcome'=>'欢迎使用MacCMS Pro',
    ...
    'admin/system/config/site_security'=>'安全设置',
    'admin/system/config/urls_send'=>'URL推送设置',
    ...
    'admin/system/config/site_baidu_send'=>'百度推送',
    'admin/system/config/site_360_send'=>'360推送',
    'admin/system/config/site_sougou_send'=>'搜狗推送',
    'admin/system/config/site_shenma_send'=>'神马推送',
    'admin/system/config/site_baidu_token'=>'百度Token',
    'admin/system/config/site_360_token'=>'360Token',
    'admin/system/config/site_360_username'=>'360用户名',
    'admin/system/config/site_360_email'=>'邮箱',
    'admin/system/config/site_sougou_token'=>'搜狗Token',
    'admin/system/config/site_sougou_user_name'=>'搜狗用户名',
    'admin/system/config/site_sougou_mail'=>'搜狗推送邮箱',
    'admin/system/config/site_shenma_token'=>'神马Token',
    'admin/system/config/site_baidu_token_tip'=>'请输入百度URL推送token',
    'admin/system/config/site_360_token_tip'=>'请输入360URL推送token',
    'admin/system/config/site_360_username_tip'=>'请输入360URL推送用户名',
    'admin/system/config/site_sougou_token_tip'=>'请输入搜狗URL推送token',
    'admin/system/config/site_shenma_token_tip'=>'请输入神马URL推送token',
    'admin/system/config/site_sougou_mail_tip'=>'请输入搜狗推送邮箱',
    'admin/system/config/site_sougou_user_name_tip'=>'请输入搜狗推送邮箱',
    'admin/system/config/site_send_apiurl'=>'推送API地址',
    'admin/system/config/site_send_urls'=>'要推送的urls',
    'admin/system/config/site_send_urls_tip'=>'多个url用,分隔',
    ...
    'admin/system/config/site_announcement'=>'站点公告',
    'admin/system/config/site_ccgongji'=>'防CC攻击开启',
    'admin/system/config/site_cc_time'=>'防CC攻击频率',
    'admin/system/config/site_refresh_time'=>'waf刷新时间',
    ...
    'admin/addon/market'=>'应用市场',
    'admin/addon/market_theme'=>'模板市场',
    'admin/addon/market_name'=>'应用名称',
    'admin/addon/markettheme_name'=>'模板名称',
    'admin/addon/market_username'=>'开发者名称',
    'admin/addon/market_is_free'=>'是否收费',
    'admin/addon/market_status'=>'应用状态',
    'admin/addon/market_status_0'=>'审核中',
    'admin/addon/market_status_-1'=>'审核未通过',
    'admin/addon/market_status_1'=>'审核通过',
    'admin/addon/market_create_time'=>'提审时间',
    'admin/addon/market_update_time'=>'审核时间',
    ...
    'admin/vod/tv'=>'电视频道',
    'admin/vod/trysee'=>'试看',
    'admin/vod/trysee_time'=>'试看时长',
    'admin/vod/trysee_time_unit'=>'单位:秒',
    ...
    'admin/template/title'=>'本地模板',
    'admin/template/market'=>'模板市场',
    ...
    'admin/make/select_type_err'=>'未选中左侧任何主题',
    ...
    'install/header1'=>'感谢您选择！',
    'install/header2'=>'MacCMS Pro系统建站',
    'install/lang'=>'语言包[langs]',
    'install/select_lang'=>'请选择语言包[select lang]',
    'install/lang_tip'=>'请根据自己身需要选择后台语言包',

    'install/user_agreement_title'=>'MacCMS Pro用户协议 适用于所有用户',
    'install/user_agreement'=>' 请您在使用(MacCMS Pro)前仔细阅读如下条款。包括免除或者限制作者责任的免责条款及对用户的权利限制。您的安装使用行为将视为对本《用户许可协议》的接受，并同意接受本《用户许可协议》各项条款的约束。 <br /><br />
                一、安装和使用： <br />
                (MacCMS Pro)是免费和开源提供给您使用的，您可安装无限制数量副本。 您必须保证在不进行非法活动，不违反所在国家相关政策法规的前提下使用本软件。 <br /><br />
                二、免责声明：  <br />
                ...
                三、协议规定的约束和限制：  <br />
                禁止去除(MacCMS Pro)源码里的版权信息，商业授权版本可去除后台界面及前台界面的相关版权信息。</br>
                禁止在(MacCMS Pro)整体或任何部分基础上发展任何派生版本、修改版本或第三方版本用于重新分发。</br></br>
                <strong>版权所有 (c) 2020，MacCMS Pro,保留所有权利</strong>。',
    ...
    'install/is_ok'=>'系统安装成功，欢迎您使用MacCMS Pro建站',
    'install/is_ok1'=>'系统安装成功！',
    'install/is_ok2'=>'欢迎您使用MacCMS Pro建站',
    'install/os'=>'操作系统',
    'install/php'=>'php版本',
    'install/gd'=>'GD库',
    'install/php_version'=>'5.5及以上',
    'install/jump_time'=>'页面自动跳转 等待时间：',
    'install/jump_button'=>'跳转',
    ...
    'dispatch_jump/jump' => '跳转',
    'dispatch_jump/notice' => '页面自动跳转 等待时间',
    ...
    'admin/system/whole_style' => '整体风格',
    'admin/system/theme_color' => '主题配色',
    'admin/system/lang_change' => '语言切换',
    'admin/system/close_current' => '关闭当前',
    'admin/system/close_other' => '关闭其他',
    'admin/system/close_all' => '关闭全部',

    'others/botlist/log_stat' => '爬虫日志统计',
    'others/botlist/data' => '日期',
    'others/botlist/total' => '总计',
    'others/botlist/action' => '操作',
    'others/botlist/log' => '日志',

    'admin/collect/index/video_collect' => '进入视频断点采集',
    'admin/collect/index/art_collect' => '进入文章断点采集',
    'admin/collect/index/star_collect' => '进入明星断点采集',
    'admin/collect/index/role_collect' => '进入角色断点采集',
    'admin/collect/index/website_collect' => '进入网址断点采集',
    'admin/collect/index/api_type' => '接口类型',
    'admin/collect/index/source_type' => '资源类型',
    'admin/collect/index/source_website' => '资源站',
    'admin/collect/index/collect_item' => '采集选项',
    'admin/collect/index/collect_today' => '采集当天',
    'admin/collect/index/collect_week' => '采集本周',
    'admin/collect/index/collect_all' => '采集所有',
    
    'admin/banner/index/choose_loc' => '选择广告位置',
    'admin/banner/index/choose_status' => '选择状态',
    'admin/banner/index/close' => '关闭',
    'admin/banner/index/show' => '显示',
    'admin/banner/index/search' => '查询',
    'admin/banner/index/add_loc' => '添加位置',
    'admin/banner/index/add' => '添加',
    'admin/banner/index/del' => '删除',
    'admin/banner/index/img' => '图片',
    'admin/banner/index/name' => '名称',
    'admin/banner/index/link' => '链接',
    'admin/banner/index/action' => '操作',
    'admin/banner/index/update' => '编辑',
    'admin/banner/index/show_time' => '显示时间',
    'admin/banner/index/show_status' => '显示状态',
    'admin/banner/index/search_condition' => '请输入搜索条件',
    ...
    'admin/banner/index/ad_name' => '请输入广告名称',
    'admin/banner/index/uploading' => '文件上传中...',

    'index/ajax/watch_progress/user_login' => '未登录用户',
    'index/ajax/watch_progress/param_error' => '参数错误',
    ...
    'admin/addon/marketfeedback/desc1' =>'问题反馈',
    'admin/addon/marketfeedback/desc2' =>'应用名称',
    'admin/addon/marketfeedback/desc3' =>'版本号',
    'admin/addon/marketfeedback/desc4' =>'请选择版本号',
    'admin/addon/marketfeedback/desc5' =>'反馈内容',
    'admin/addon/marketfeedback/desc6' =>'问题截图',
    'admin/addon/marketfeedback/desc7' =>'支持图片格式JPG,PNG，每张最大3MB',
    'admin/addon/marketfeedback/desc8' =>'问题视频',
    'admin/addon/marketfeedback/desc9' =>'支持视频格式AVI,MP4,MPEG，每个最大3MB',
    'admin/addon/marketfeedback/desc10' =>'确定提交',
    
    'admin/addon/marketinfo/title1' =>'开发者',
    'admin/addon/marketinfo/title2' =>'开发者网址',
    'admin/addon/marketinfo/title3' =>'描述',
    'admin/addon/marketinfo/title4' =>'授权码兑换',
    'admin/addon/marketinfo/title5' =>'下载应用',
    'admin/addon/marketinfo/title6' =>'一键安装',
    'admin/addon/marketinfo/title7' =>'版本',
    'admin/addon/marketinfo/title8' =>'最近更新时间',
    'admin/addon/marketinfo/title9' =>'安装数量',
    'admin/addon/marketinfo/title10' =>'支持语言',
    'admin/addon/marketinfo/title11' =>'问题反馈',
    'admin/addon/marketinfo/title12' =>'联系方式',
    'admin/addon/marketinfo/title13' =>'微信',

    'admin/addon/marketlicense/desc1' =>'授权码验证',
    'admin/addon/marketlicense/desc2' =>'请输入授权码',
    'admin/addon/marketlicense/desc3' =>'立即验证',
    'admin/addon/marketlicense/desc4' =>'请填写兑换码',
    'admin/addon/marketlicense/desc5' =>'安装应用',
    'admin/addon/marketlicense/desc6' =>'下载应用',
    ...
    'admin/app/add/title4' =>'下载类型',
    'admin/app/add/title5' =>'URL地址',
    'admin/app/add/title6' =>'升级说明',
    'admin/app/add/title7' =>'URL下载',
    
    
    'admin/banner/infocat/desc1' =>'英文编码',
    'admin/banner/infocat/desc2' =>'请输入英文编码',

    'admin/cj/info/title1' =>'从',
    'admin/cj/info/title2' =>'内容',

    'admin/collect/timing/title1' =>'执行中',
    'admin/collect/timing/title2' =>'执行任务',
    'admin/collect/timing/title3' =>'今日没有更新的数据，所以栏目无需更新',
    'admin/collect/timing/title4' =>'定时采集生成插件WEB挂机版',
    'admin/collect/timing/title5' =>'注：不需要定时操作的模块,请填写0',
    'admin/collect/timing/title6' =>'采集抓取频率(分钟/次)',
    'admin/collect/timing/title7' =>'内容生成频率(分钟/次)',
    'admin/collect/timing/title8' =>'首页生成频率(分钟/次)',
    'admin/collect/timing/title9' =>'栏目生成频率(分钟/次)',
    'admin/collect/timing/title10' =>'停止执行',
    'admin/collect/timing/title11' =>'视频_定时采集',
    'admin/collect/timing/title12' =>'视频_定时生成内容页',
    'admin/collect/timing/title13' =>'视频_定时生成首页',
    'admin/collect/timing/title14' =>'视频_定时生成栏目页',
    'admin/collect/timing/title15' =>'等侍中',

    'admin/extend/email/send_tip' =>'发送邮件请开启sockets ,openssl扩展库，否则可能发送失败',
    'admin/extend/email/smtp_server' =>'smtp服务器',
    'admin/extend/email/smtp_port' =>'smtp端口',
    'admin/extend/email/trans_protocol' =>'传输协议',
    'admin/extend/email/default' =>'默认',
    'admin/extend/email/deppend_on_server' =>'根据邮件服务器要求配置',
    'admin/extend/email/account' =>'帐号',
    'admin/extend/email/smtp_account' =>'smtp服务帐号',
    'admin/extend/email/smtp_pass' =>'smtp服务密码',
    
    'admin/extend/alipay/desc1' =>'支付宝设置',
    'admin/extend/alipay/desc2' =>'点击进入注册',
    'admin/extend/alipay/desc3' =>'收款账号',
    'admin/extend/alipay/desc4' =>'合作者身份',
    'admin/extend/alipay/desc5' =>'安全校验码',

    'admin/extend/codepay/desc1' =>'码支付设置',
    'admin/extend/codepay/desc2' =>'支付商家编号',
    'admin/extend/codepay/desc3' =>'支付商家密钥',
    'admin/extend/codepay/desc4' =>'商家收款平台',
    'admin/extend/codepay/desc5' =>'1：支付宝；2：QQ钱包；3：微信（多个用逗号分隔）',
    'admin/extend/codepay/desc6' =>'收款通知类型',
    'admin/extend/codepay/desc7' =>'0表示及时到账 1则为商家代收款',

    'admin/extend/funpay/desc1' =>'乐付支付设置',
    'admin/extend/funpay/desc2' =>'支付商家编号',
    'admin/extend/funpay/desc3' =>'支付商家密钥',
    'admin/extend/funpay/desc4' =>'收款渠道编号',
    'admin/extend/funpay/desc5' =>'1：微信H5；2：支付宝H5；（多个用逗号分隔）',

    'admin/extend/weixin/desc1' =>'微信设置',
    'admin/extend/weixin/desc2' =>'点击进入注册',
    'admin/extend/weixin/desc3' =>'商户号',
    'admin/extend/weixin/desc4' =>'商户密钥',

    'admin/extend/aliyun/desc1' =>'阿里云短信',
    'admin/extend/aliyun/desc2' =>'阿里云短信模板例子',
    'admin/extend/aliyun/desc3' =>'尊敬的用户，您的注册会员验证码为',
    'admin/extend/aliyun/desc4' =>'请勿泄漏于他人！',
    'admin/extend/aliyun/desc5' =>'验证码为',
    'admin/extend/aliyun/desc6' =>'您正在绑定手机，若非本人操作，请勿泄露。',
    'admin/extend/aliyun/desc7' =>'您正在进行密码重置操作，如非本人操作，请忽略本短信！',

    'admin/extend/qcloud/desc1' =>'腾讯云短信',
    'admin/extend/qcloud/desc2' =>'腾讯云短信模板例子',
    
    'admin/upload/alibaba/desc1' =>'阿里巴巴图床',
    'admin/upload/alibaba/desc2' =>'目前免费不用申请',

    'admin/extend/upload/title1' =>'FTP存储',
    'admin/extend/upload/title2' =>'请确认FTP可以正常连接',
    'admin/extend/upload/title3' =>'服务器',
    'admin/extend/upload/title4' =>'端口',
    'admin/extend/upload/title5' =>'账号',
    'admin/extend/upload/title6' =>'ip或域名',
    'admin/extend/upload/title7' =>'端口号',
    'admin/extend/upload/title8' =>'ftp账号',
    'admin/extend/upload/title9' =>'密码',
    'admin/extend/upload/title10' =>'ftp密码',
    'admin/extend/upload/title11' =>'路径',
    'admin/extend/upload/title12' =>'网站根路径',
    'admin/extend/upload/title13' =>'外链URL',
    'admin/extend/upload/title14' =>'七牛云API',
    'admin/extend/upload/title15' =>'点击申请',
    'admin/extend/upload/title16' =>'>服务名',
    'admin/extend/upload/title17' =>'七牛云-服务名',
    'admin/extend/upload/title18' =>'公钥',
    'admin/extend/upload/title19' =>'七牛云-公钥',
    'admin/extend/upload/title20' =>'私钥',
    'admin/extend/upload/title21' =>'七牛云-私钥',
    'admin/extend/upload/title22' =>'七牛云-外链URL',
    'admin/extend/upload/title23' =>'优启梦图床',
    'admin/extend/upload/title24' =>'目前免费不用申请',
    'admin/extend/upload/title25' =>'操作员名',
    'admin/extend/upload/title26' =>'类型',
    'admin/extend/upload/title27' =>'阿里巴巴',
    'admin/extend/upload/title28' =>'百度识图',
    'admin/extend/upload/title29' =>'新浪微博',
    'admin/extend/upload/title30' =>'搜狗图片',
    'admin/extend/upload/title31' =>'掘金社区',
    'admin/extend/upload/title32' =>'奇虎360',
    'admin/extend/upload/title33' =>'京东商城', 
    'admin/extend/upload/title34' =>'又云拍API',
    'admin/extend/upload/title35' =>'点击申请',
    'admin/extend/upload/title36' =>'服务名',
    'admin/extend/upload/title37' =>'又云拍-服务名',
    'admin/extend/upload/title38' =>'操作员名',
    'admin/extend/upload/title39' =>'又云拍-操作员名',
    'admin/extend/upload/title40' =>'操作员密码',
    'admin/extend/upload/title41' =>'又云拍-操作员密码',
    'admin/extend/upload/title42' =>'又云拍-外链URL',
    'admin/extend/upload/title43' =>'获取尺寸',
    'admin/extend/upload/title44' =>'登录cookie-会自动读取',
    'admin/extend/upload/title45' =>'登录时间-不用设置',
    'admin/extend/upload/title46' =>'昵称',
    'admin/extend/upload/title47' =>'留言时间',
    'admin/extend/upload/title48' =>'回复时间',
    'admin/extend/upload/title49' =>'留言内容',
    'admin/extend/upload/title50' =>'回复内容',
    'admin/extend/upload/title51' =>'请输入评论内容',
    'admin/extend/upload/title52' =>'请输入回复内容',


    'admin/system/config/desc1' =>'爬虫日志',
    'admin/system/config/desc2' =>'百度收录域名',
    'admin/system/config/desc3' =>'设置',
    'admin/system/config/desc4' =>'系统生成',
    'admin/system/config/desc5' =>'手动输入',
    'admin/system/config/desc6' =>'由于360官网限制单次最多推送5条网址',
    'admin/system/config/desc7' =>'验证码',
    'admin/system/config/desc8' =>'用户名',
    'admin/system/config/desc9' =>'邮箱',
    'admin/system/config/desc10' =>'神马用户名',
    'admin/system/config/desc11' =>'神马收录域名',
    'admin/system/config/desc12' =>'搜索频次-分',
    'admin/system/config/desc13' =>'单IP 每分钟最大搜索次数，可控制QPS',
    'admin/system/config/desc14' =>'搜索频次-时',
    'admin/system/config/desc15' =>'单IP 每小时最大搜索次数，一般为爬虫持续搜索',
    'admin/system/config/desc16' =>'>搜索频次-天',
    'admin/system/config/desc17' =>'单IP 24小时最大搜索次数，服务器负载高时可设置小一些',
    'admin/system/config/desc18' =>'秒',
    'admin/system/config/desc19' =>'每秒次数',
    'admin/system/config/desc20' =>'百度',
    'admin/system/config/desc21' =>'百度收录域名',
    'admin/system/config/desc22' =>'请填写百度收录域名',
    'admin/system/config/desc23' =>'申请地址',
    'admin/system/config/desc24' =>'搜狗',
    'admin/system/config/desc25' =>'神马',
    'admin/system/config/desc26' =>'域名',
    'admin/system/config/desc27' =>'神马用户名',
    'admin/system/config/desc28' =>'神马用户',
    'admin/system/config/desc29' =>'全黑色',
    'admin/system/config/desc30' =>'浅蓝色',
    'admin/system/config/desc31' =>'浅紫色',
    'admin/system/config/desc32' =>'浅绿色',
    'admin/system/config/desc33' =>'提示信息', 
    'admin/system/config/desc34' =>'为了安全考量避免通过模板写入后门文件，文件内出现以下任意字符串时禁止在线保存修改，如需修改请使用其他方式。',
    'admin/system/config/desc35' =>'提示信息：部分标签参数可能不全面',
    'admin/system/config/desc36' =>'标签类别',
    'admin/system/config/desc37' =>'广告',
    'admin/system/config/desc38' =>'排序',
    'admin/system/config/desc39' =>'数据',
    'admin/system/config/desc40' =>'全部广告',
    'admin/system/config/desc41' =>'自定义编码',
    'admin/system/config/desc42' =>'一级',
    'admin/system/config/desc43' =>'二级',
    'admin/system/config/desc44' =>'顶数',
    'admin/system/config/desc45' =>'踩数',
    'admin/system/config/desc46' =>'标签参数',
    'admin/system/config/desc47' =>'序号',
    'admin/system/config/desc48' =>'编号',
    'admin/system/config/desc49' =>'名称',
    'admin/system/config/desc50' =>'图片',
    'admin/system/config/desc51' =>'链接地址',
    'admin/system/config/desc52' =>'播放器类型',
    'admin/system/config/desc53' =>'下载器类型',
    'admin/system/config/desc54' =>'无数据',
    'admin/system/config/desc55' =>'版权',

    'admin/public/index/title1' =>'基本设置',
    'admin/public/index/title2' =>'播放器代码',
    'admin/public/index/title3' =>'网站维护中',
    'admin/public/index/title4' =>'非常抱歉，网站正在维护中',
    'admin/public/index/title5' =>'亲爱的站长们',
    'admin/public/index/title6' =>'为了能让您访问更快更稳定，同时为您提供更高品质的服务，我们正在维护系统。因此目前网站的部分功能不能使用，请稍后再回来。给您造成了不便，请谅解。',
    'admin/public/index/title7' =>'页面自动',
    'admin/public/index/title8' =>'跳转',
    'admin/public/index/title9' =>'等待时间',
    'admin/public/index/title10' =>'请设置href参数',
    'admin/public/index/title11' =>'请选择要操作的数据',
    'admin/public/index/title12' =>'请设置data-href参数',
    'admin/public/index/title13' =>'数据提交中...',
    'admin/public/index/title14' =>'删除之后无法恢复，您确定要删除吗？',
    'admin/public/index/title15' =>'您确定要执行此操作吗？',
    'admin/public/index/title16' =>'添加成功!',
    'admin/public/index/title17' =>'请输入登录密码解锁...',
    'admin/public/index/title18' =>'解锁',
    'admin/public/index/title19' =>'信息',
    'admin/public/index/title20' =>'确定',
    'admin/public/index/title21' =>'取消',
    'admin/public/index/title22' =>'最多打开',
    'admin/public/index/title23' =>'个标签页',
    'admin/public/index/title24' =>'当前页面不允许关闭',




    'admin/tpl/config/desc1' =>'基本设置',
    'admin/tpl/config/desc2' =>'首页配置',
    'admin/tpl/config/desc3' =>'页面配置',
    'admin/tpl/config/desc4' =>'导航菜单',
    'admin/tpl/config/desc5' =>'推广展示',
    'admin/tpl/config/desc6' =>'其他设置',
    'admin/tpl/config/desc7' =>'SEO设置',
    'admin/tpl/config/desc8' =>'广告设置',
    'admin/tpl/config/desc10' =>'深色logo',
    'admin/tpl/config/desc11' =>'深色logo地址或路径',
    'admin/tpl/config/desc12' =>'选择文件',
    'admin/tpl/config/desc13' =>'适用于浅色页面展示，建议根据演示图片大小制作',
    'admin/tpl/config/desc14' =>'浅色logo',
    'admin/tpl/config/desc15' =>'浅色logo地址或路径',
    'admin/tpl/config/desc16' =>'适用于深色页面展示，建议根据演示图片大小制作',
    'admin/tpl/config/desc17' =>'网页图标',
    'admin/tpl/config/desc18' =>'网页图标地址或路径',
    'admin/tpl/config/desc19' =>'浏览器窗口小图标，支持png，建议根据演示图片大小制作',
    'admin/tpl/config/desc20' =>'网页收藏或添加到桌面展示的图标，建议根据演示图片大小制作',
    'admin/tpl/config/desc21' =>'webapp图标',
    'admin/tpl/config/desc22' =>'webapp图标地址或路径',
    'admin/tpl/config/desc23' =>'懒加载图',
    'admin/tpl/config/desc24' =>'懒加载图地址或路径',
    'admin/tpl/config/desc25' =>'封面懒加载图，建议根据演示图片大小制作',
    'admin/tpl/config/desc26' =>'前台统计',
    'admin/tpl/config/desc27' =>'隐藏',
    'admin/tpl/config/desc28' =>'开启',
    'admin/tpl/config/desc29' =>'开启后，前台显示统计链接（开启与隐藏都不影响统计代码的正常运行）',
    'admin/tpl/config/desc30' =>'头部代码',
    'admin/tpl/config/desc31' =>'底部提示',
    'admin/tpl/config/desc32' =>'支持html代码，css样式代码',
    'admin/tpl/config/desc33' =>'支持html代码，免责声明',
    'admin/tpl/config/desc34' =>'显示分类',
    'admin/tpl/config/desc35' =>'显示分类ID',
    'admin/tpl/config/desc36' =>'分类模块ID',
    'admin/tpl/config/desc37' =>'要展示的首页分类ID，留空显示全部，多个ID用“,”分隔',
    'admin/tpl/config/desc38' =>'显示数量',
    'admin/tpl/config/desc39' =>'6个',
    'admin/tpl/config/desc40' =>'12个',
    'admin/tpl/config/desc41' =>'分类数据展示数量（不同屏幕宽度下显示数量会有变化）',
    'admin/tpl/config/desc42' =>'分类菜单',
    'admin/tpl/config/desc43' =>'菜单状态',
    'admin/tpl/config/desc44' =>'关闭',
    'admin/tpl/config/desc45' =>'关闭后不显示对应模块和内容',
    'admin/tpl/config/desc46' =>'分类菜单ID',
    'admin/tpl/config/desc47' =>'要展示的首页分类菜单，多个ID用“,”分隔，最多6个',
    'admin/tpl/config/desc48' =>'菜单显示',
    'admin/tpl/config/desc49' =>'显示一行',
    'admin/tpl/config/desc50' =>'显示两行',
    'admin/tpl/config/desc51' =>'展示的分类ID',



    'admin/tpl/config/title1' =>'本设置仅对PC端有效',
    'admin/tpl/config/title2' =>'公告设置',
    'admin/tpl/config/title3' =>'公告状态',
    'admin/tpl/config/title5' =>'公告内容',
    'admin/tpl/config/title6' =>'请输入公告内容，支持html代码',
    'admin/tpl/config/title7' =>'弹窗状态',
    'admin/tpl/config/title9' =>'弹窗标题',
    'admin/tpl/config/title10' =>'弹窗公告显示标题',
    'admin/tpl/config/title11' =>'弹窗内容',
    'admin/tpl/config/title12' =>'请输入弹窗公告内容，支持html代码',
    'admin/tpl/config/title13' =>'推荐模块',
    'admin/tpl/config/title14' =>'模块状态',
    'admin/tpl/config/title15' =>'关闭后不显示对应模块和内容，设置“推荐1”',
    'admin/tpl/config/title16' =>'模块标题',
    'admin/tpl/config/title17' =>'关闭后不显示对应模块和内容（全站资讯模块没有开启，本按钮将失效）',
    'admin/tpl/config/title18' =>'推荐模块的标题',
    'admin/tpl/config/title19' =>'显示数量',
    'admin/tpl/config/title20' =>'推荐数据展示数量（不同屏幕宽度下显示数量会有变化）',
    'admin/tpl/config/title21' =>'资讯模块',
    'admin/tpl/config/title23' =>'（全站资讯模块没有开启，本按钮将失效）',
    'admin/tpl/config/title26' =>'要展示的标题',
    'admin/tpl/config/title27' =>'专题模块',
    'admin/tpl/config/title29' =>'关闭后不显示对应模块和内容（全站专题模块没有开启，本按钮将失效）',
    'admin/tpl/config/title33' =>'显示数量', 
    'admin/tpl/config/title34' =>'专题数据展示数量（不同屏幕宽度下显示数量会有变化）',
    'admin/tpl/config/title35' =>'明星模块',
    'admin/tpl/config/title36' =>'关闭后不显示对应模块和内容，设置明星“推荐1”',
    'admin/tpl/config/title37' =>'模块ID',
    'admin/tpl/config/title38' =>'请输入明星ID',
    'admin/tpl/config/title39' =>'明星ID，留空模块关闭',
    'admin/tpl/config/title43' =>'排行模块',
    'admin/tpl/config/title46' =>'排行显示',
    'admin/tpl/config/title47' =>'周榜',
    'admin/tpl/config/title48' =>'月榜',
    'admin/tpl/config/title49' =>'总榜',
    'admin/tpl/config/title50' =>'可按不同时间显示排行榜',




    'admin/tpl/config/tip1' =>'显示分类ID',
    'admin/tpl/config/tip2' =>'请输入分类ID',
    'admin/tpl/config/tip3' =>'要展示的分类ID，多个ID用“,”分隔，最多显示4个',
    'admin/tpl/config/tip7' =>'友链模块',
    'admin/tpl/config/tip13' =>'显示数量',
    'admin/tpl/config/tip14' =>'请输入显示的数量',
    'admin/tpl/config/tip15' =>'要展示的友情链接数量',
    'admin/tpl/config/tip16' =>'幻灯设置',
    'admin/tpl/config/tip17' =>'幻灯片状态',
    'admin/tpl/config/tip18' =>'关闭后不显示对应模块和内容，设置“推荐9”',
    'admin/tpl/config/tip19' =>'列表页幻灯',
    'admin/tpl/config/tip20' =>'关闭后列表页不显示对应模块和内容',
    'admin/tpl/config/tip21' =>'幻灯片模式',
    'admin/tpl/config/tip22' =>'小图模式',
    'admin/tpl/config/tip23' =>'大图模式',
    'admin/tpl/config/tip24' =>'大图模式需要上传海报图，建议尺寸1680px*580px',
    'admin/tpl/config/tip25' =>'幻灯片背景',
    'admin/tpl/config/tip26' =>'隐藏',
    'admin/tpl/config/tip27' =>'显示',
    'admin/tpl/config/tip28' =>'自定义背景，例如颜色#282832，或url(图片地址)等',
    'admin/tpl/config/tip29' =>'隐藏小图模式及部分页面模糊背景效果，可自定义背景（如果开启模糊背景，自定义背景留空，模糊效果会增加浏览器性能消耗）',
    'admin/tpl/config/tip30' =>'搜索设置',
    'admin/tpl/config/tip31' =>'显示文字',
    'admin/tpl/config/tip32' =>'请输入需要显示的文字',
    'admin/tpl/config/tip33' =>'视频搜索框默认的提示文字', 
    'admin/tpl/config/tip34' =>'联想搜索',
    'admin/tpl/config/tip36' =>'列表页面',
    'admin/tpl/config/tip37' =>'默认样式ID',
    'admin/tpl/config/tip38' =>'调用模块ID',
    'admin/tpl/config/tip39' =>'展示有二级分类的一级分类页面，多个ID用“,”分隔',
    'admin/tpl/config/tip40' =>'地区样式ID',
    'admin/tpl/config/tip41' =>'调用模块ID',
    'admin/tpl/config/tip42' =>'展示无二级分类的一级分类页面，多个ID用“,”分隔',
    'admin/tpl/config/tip43' =>'横版样式ID',
    'admin/tpl/config/tip45' =>'展示频封面横版的分类页面，多个ID用“,”分隔，填写“999”不启用',
    'admin/tpl/config/tip46' =>'直播模块ID',
    'admin/tpl/config/tip48' =>'展示直播分类页面，只能填写一个ID，填写“999”不启用',
    'admin/tpl/config/tip49' =>'列表数据',
    'admin/tpl/config/tip50' =>'显示数量',
    ...
    'admin/tpl/config/key1' =>'分类数据展示数量，仅对已分类列表有效（不同屏幕宽度下显示数量会有变化）',
    'admin/tpl/config/key2' =>'播放页面',
    'admin/tpl/config/key3' =>'播放器高度',
    'admin/tpl/config/key4' =>'%，播放器自适应高度，默认高度56.25%，本设置仅对移动端有效',
    'admin/tpl/config/key5' =>'播放器广告',
    'admin/tpl/config/key6' =>'控制播放器上方的全站通栏横幅广告（仅播放页有效），默认开启有需要可关闭。',
    'admin/tpl/config/key7' =>'播放提示',
    'admin/tpl/config/key9' =>'提示内容',
    'admin/tpl/config/key10' =>'填写示例',
    'admin/tpl/config/key11' =>'第1条提示',
    'admin/tpl/config/key12' =>'第2条提示',
    'admin/tpl/config/key13' =>'依此类推',
    'admin/tpl/config/key14' =>'请输入提示内容，支持html代码',
    'admin/tpl/config/key15' =>'筛选页面',
    'admin/tpl/config/key16' =>'筛选规则',
    'admin/tpl/config/key17' =>'分类',
    'admin/tpl/config/key18' =>'类型',
    'admin/tpl/config/key19' =>'地区',
    'admin/tpl/config/key20' =>'年份',
    'admin/tpl/config/key21' =>'语言',
    'admin/tpl/config/key22' =>'字母',
    'admin/tpl/config/key23' =>'勾选需要的筛选规则',
    'admin/tpl/config/key24' =>'跳转页面',
    'admin/tpl/config/key25' =>'跳转状态',
    'admin/tpl/config/key26' =>'开启后，点击视频信息跳转到播放页，默认跳转内容页，对部分页面无效，例如：直播模块，横版样式等',
    'admin/tpl/config/key27' =>'排行模块',
    'admin/tpl/config/key28' =>'排行显示',
    'admin/tpl/config/key29' =>'可按不同时间显示排行榜，模块主要分布内容页/下载页/播放页',
    'admin/tpl/config/key30' =>'顶部导航',
    'admin/tpl/config/key31' =>'友情提示',
    'admin/tpl/config/key32' =>'建议最多显示7个菜单（包含开启的自定义菜单），请合理选择。',
    'admin/tpl/config/key33' =>'要展示的右上角自定义菜单', 
    'admin/tpl/config/key34' =>'显示分类',
    'admin/tpl/config/key35' =>'要展示的导航分类，留空显示全部，多个ID用“,”分隔',
    'admin/tpl/config/key36' =>'自定义菜单',
    'admin/tpl/config/key37' =>'导航分类ID',
    'admin/tpl/config/key38' =>'本按钮仅对自定义菜单有效，关闭后不显示对应模块和内容',
    'admin/tpl/config/key39' =>'自定义菜单',
    'admin/tpl/config/key41' =>'可在顶部导航菜单基础上增加4个自定义链接（菜单开启状态下显示），同时在全部分类内显示',
    'admin/tpl/config/key42' =>'自定义1',
    'admin/tpl/config/key45' =>'菜单名称',
    'admin/tpl/config/key46' =>'菜单链接',
    'admin/tpl/config/key47' =>'菜单图标地址或路径',
    'admin/tpl/config/key48' =>'要展示的自定义导航菜单',
    'admin/tpl/config/key49' =>'自定义2',
    ...
    'admin/tpl/config/field4' =>'自定义3',
    'admin/tpl/config/field9' =>'自定义4',
    'admin/tpl/config/field14' =>'右上角菜单',
    'admin/tpl/config/field15' =>'建议最多显示5个菜单，请合理选择。',
    'admin/tpl/config/field16' =>'可选页面',
    'admin/tpl/config/field17' =>'历史',
    'admin/tpl/config/field18' =>'专题',
    'admin/tpl/config/field19' =>'留言',
    'admin/tpl/config/field20' =>'更新',
    'admin/tpl/config/field21' =>'排行',
    'admin/tpl/config/field22' =>'微信',
    'admin/tpl/config/field23' =>'会员',
    'admin/tpl/config/field24' =>'建议不要勾选过多（对应菜单全站关闭，勾选将失效）',
    'admin/tpl/config/field30' =>'底部导航',
    'admin/tpl/config/field31' =>'建议最多显示5个菜单（可按分类/页面/自定义的自由组合形式），请合理选择。',
    'admin/tpl/config/field32' =>'导航状态',
    'admin/tpl/config/field35' =>'导航分类ID',
    'admin/tpl/config/field36' =>'要展示的导航分类，多个ID用“,”分隔',
    'admin/tpl/config/field37' =>'可选页面',
    'admin/tpl/config/field38' =>'首页',
    'admin/tpl/config/field39' =>'专题',
    'admin/tpl/config/field40' =>'留言',
    'admin/tpl/config/field41' =>'更新',
    'admin/tpl/config/field42' =>'排行',
    'admin/tpl/config/field43' =>'角色',
    'admin/tpl/config/field44' =>'剧情',
    'admin/tpl/config/field45' =>'会员',
    'admin/tpl/config/field46' =>'建议不要勾选过多（对应菜单全站关闭，勾选将失效）',
    'admin/tpl/config/field49' =>'要展示的底部自定义菜单',
    'admin/tpl/config/field50' =>'分享链接',





    'admin/tpl/config/element1' =>'如果使用短链接，请二选一填写。如果不使用短链接，请保持默认设置，如更改可能会出错。新浪和百度的短链填写方法略有不同。',
    'admin/tpl/config/element2' =>'百度分享按钮',
    'admin/tpl/config/element3' =>'默认仅PC端显示，关闭后不显示对应模块和内容',
    'admin/tpl/config/element4' =>'短链接API',
    'admin/tpl/config/element5' =>'新浪',
    'admin/tpl/config/element6' =>'百度',
    'admin/tpl/config/element7' =>'选择短链接生成方式',
    'admin/tpl/config/element8' =>'自定义域名',
    'admin/tpl/config/element9' =>'自定义分享域名，对链接分享有效，留空获取当前网站域名',
    'admin/tpl/config/element10' =>'新浪接口',
    'admin/tpl/config/element11' =>'输入新浪接口链接，留空不启用',
    'admin/tpl/config/element12' =>'例如',
    'admin/tpl/config/element13' =>'请输入新浪接口连接',
    'admin/tpl/config/element14' =>'新浪接口申请',
    'admin/tpl/config/element15' =>'百度接口',
    'admin/tpl/config/element16' =>'输入百度Token',
    'admin/tpl/config/element17' =>'申请新浪接口',
    'admin/tpl/config/element18' =>'永久有效',
    'admin/tpl/config/element19' =>'一年有效',
    'admin/tpl/config/element20' =>'可选短链有效期，',
    'admin/tpl/config/element21' =>'百度Token申请',
    'admin/tpl/config/element22' =>'申请百度Token',
    'admin/tpl/config/element23' =>'联系方式',
    'admin/tpl/config/element24' =>'按钮状态',
    'admin/tpl/config/element26' =>'联系标题',
    'admin/tpl/config/element27' =>'输入要展示的标题',
    'admin/tpl/config/element28' =>'要展示的标题，建议QQ或QQ群相关',
    'admin/tpl/config/element29' =>'联系链接',
    'admin/tpl/config/element30' =>'输入跳转链接',
    'admin/tpl/config/element31' =>'建议QQ链接或QQ群链接',
    'admin/tpl/config/element32' =>'微信关注',
    'admin/tpl/config/element33' =>'关注状态', 
    'admin/tpl/config/element35' =>'按钮内容',
    'admin/tpl/config/element36' =>'请输入内容',
    'admin/tpl/config/element37' =>'播放页显示的按钮内容',
    'admin/tpl/config/element38' =>'微信二维码',
    'admin/tpl/config/element39' =>'微信二维码图片地址或路径',
    'admin/tpl/config/element41' =>'弹窗显示标题',
    'admin/tpl/config/element43' =>'弹窗显示内容，支持html代码',
    'admin/tpl/config/element44' =>'赞赏设置',
    'admin/tpl/config/element45' =>'赞赏状态',
    'admin/tpl/config/element46' =>'赞赏二维码',
    'admin/tpl/config/element47' =>'赞赏二维码图片地址或路径',
    'admin/tpl/config/element48' =>'APP推广',
    'admin/tpl/config/element49' =>'推广状态',
    'admin/tpl/config/element50' =>'下载链接',





    'admin/tpl/config/content1' =>'APP下载链接地址',
    'admin/tpl/config/content2' =>'排行页面',
    'admin/tpl/config/content3' =>'页面状态',
    'admin/tpl/config/content4' =>'关闭后全站对应的排行入口将关闭',
    'admin/tpl/config/content7' =>'要展示的标题，所有页面中的排行榜标题',
    'admin/tpl/config/content8' =>'模块数量',
    'admin/tpl/config/content9' =>'请输入数量',
    'admin/tpl/config/content10' =>'要展示的分类数量，建议：6或9或12',
    'admin/tpl/config/content13' =>'要展示的分类ID，多个ID用“,”分隔',
    'admin/tpl/config/content14' =>'最近更新',
    'admin/tpl/config/content15' =>'页面状态',
    'admin/tpl/config/content16' =>'关闭后全站对应的最近更新入口将关闭',
    'admin/tpl/config/content21' =>'要展示的分类ID，多个ID用“,”分隔，留空显示全部',
    'admin/tpl/config/content22' =>'个性配置',
    'admin/tpl/config/content23' =>'主题颜色',
    'admin/tpl/config/content24' =>'默认主题',
    'admin/tpl/config/content25' =>'绿色主题',
    'admin/tpl/config/content26' =>'蓝色主题',
    'admin/tpl/config/content27' =>'粉色主题',
    'admin/tpl/config/content28' =>'红色主题',
    'admin/tpl/config/content29' =>'金色主题',
    'admin/tpl/config/content30' =>'关闭前台主题颜色按钮，不影响后台设置',
    'admin/tpl/config/content31' =>'浏览模式',
    'admin/tpl/config/content32' =>'白昼模式',
    'admin/tpl/config/content33' =>'暗夜模式', 
    'admin/tpl/config/content34' =>'关闭前台浏览模式按钮，不影响后台设置',
    'admin/tpl/config/content35' =>'专题模块',
    'admin/tpl/config/content37' =>'关闭后全站对应的专题入口将关闭',
    'admin/tpl/config/content38' =>'角色模块',
    'admin/tpl/config/content40' =>'关闭后全站对应的角色入口将关闭',
    'admin/tpl/config/content41' =>'剧情模块',
    'admin/tpl/config/content42' =>'请输入展示的标题',
    'admin/tpl/config/content43' =>'关闭后全站对应的剧情入口将关闭',
    'admin/tpl/config/content44' =>'留言模块',
    'admin/tpl/config/content45' =>'留言展示的标题，如需关闭留言请到CMS的留言设置',
    'admin/tpl/config/content46' =>'会员模块',
    'admin/tpl/config/content47' =>'会员展示的标题，如需关闭会员请到CMS的会员设置',
    'admin/tpl/config/content48' =>'网站字体',
    'admin/tpl/config/content49' =>'简体',
    ...
    'admin/tpl/config/word1' =>'网站字体繁简设置',
    'admin/tpl/config/word2' =>'特别说明：所需标签都已包含，无需填写。主要填写需要优化的标题，关键词等等。',
    'admin/tpl/config/word3' =>'网站首页',
    'admin/tpl/config/word4' =>'视频详情',
    'admin/tpl/config/word5' =>'视频播放',
    'admin/tpl/config/word6' =>'标题',
    'admin/tpl/config/word7' =>'关键字',
    'admin/tpl/config/word8' =>'描述',
    'admin/tpl/config/word9' =>'视频下载',
    'admin/tpl/config/word10' =>'文章首页',
    'admin/tpl/config/word11' =>'文章详情',
    'admin/tpl/config/word12' =>'专题首页',
    'admin/tpl/config/word13' =>'专题详情',
    'admin/tpl/config/word14' =>'网址首页',
    'admin/tpl/config/word15' =>'全站广告开关',
    'admin/tpl/config/word16' =>'关闭广告',
    'admin/tpl/config/word17' =>'开启广告',
    'admin/tpl/config/word18' =>'VIP会员隐藏',
    'admin/tpl/config/word19' =>'关闭后不显示全站广告',
    'admin/tpl/config/word20' =>'全站底部浮动广告',
    'admin/tpl/config/word21' =>'使用框架',
    'admin/tpl/config/word22' =>'关闭后不显示对应模块和内容，选择使用框架时广告由iframe引入',
    'admin/tpl/config/word23' =>'全站通栏横幅广告',
    'admin/tpl/config/word24' =>'请输入广告代码',
    'admin/tpl/config/word25' =>'全站对联广告',
    'admin/tpl/config/word26' =>'关闭后不显示对应模块和内容（仅适用PC端）',
    'admin/tpl/config/word27' =>'广告尺寸',
    'admin/tpl/config/word28' =>'广告宽度',
    'admin/tpl/config/word29' =>'广告高度',
    'admin/tpl/config/word30' =>'广告尺寸，宽*高（像素px）',
    'admin/tpl/config/word31' =>'广告代码',
    'admin/tpl/config/word32' =>'视频页横幅广告',
    'admin/tpl/config/word33' =>'视频页侧边栏广告', 
    'admin/tpl/config/word34' =>'关闭后不显示对应模块和内容（本模块仅PC端显示）',
    'admin/tpl/config/word35' =>'视频播放页列表栏广告',
    'admin/tpl/config/word36' =>'广告标题',
    'admin/tpl/config/word37' =>'广告图片',
    'admin/tpl/config/word38' =>'图片地址或路径',
    'admin/tpl/config/word39' =>'视频搜索页列表栏广告',
    'admin/tpl/config/word40' =>'广告副标',
    'admin/tpl/config/word41' =>'广告副标题',
    'admin/tpl/config/word42' =>'图片地址或路径',
    'admin/tpl/config/word43' =>'文章页横幅广告',
    'admin/tpl/config/word44' =>'文章页侧边栏广告',
    'admin/tpl/config/word45' =>'关闭后不显示对应模块和内容（本模块仅PC端显示）',
    'admin/tpl/config/word46' =>'文章页侧列表广告',
    'admin/tpl/config/word47' =>'广告状态',
    'admin/tpl/config/word48' =>'广告提示标签',
    'admin/tpl/config/word49' =>'广告链接',
    'admin/tpl/config/word50' =>'图片地址或路径',
    'admin/tpl/config/word51' =>'文件上传中...',
