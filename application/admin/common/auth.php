...
return array(
    ...
    '3' => array('name' => lang('menu/base'), 'icon' => 'layui-icon-set', 'sub' => array(
        ...
        '3704' => array("show"=>0,'name' => '--广告添加', 'controller' => 'banner',		'action' => 'info'),
        '3705' => array("show"=>0,'name' => '--广告位置添加', 'controller' => 'banner',		'action' => 'infocat'),
        '3706' => array("show"=>0,'name' => '--广告字段', 'controller' => 'banner',		'action' => 'field'),
      
        '38' => array("show"=>1,'name' => lang('menu/app_management'), 'controller' => 'app',       'action' => 'index'),
        '3801' => array("show"=>0,'name' => 'App管理-添加视图', 'controller' => 'app',		'action' => 'add'),
        '3802' => array("show"=>0,'name' => 'APP管理-处理添加', 'controller' => 'app',		'action' => 'doadd'),
        '3803' => array("show"=>0,'name' => 'APP管理-编辑', 'controller' => 'app',		'action' => 'edit'),
        '3804' => array("show"=>0,'name' => 'APP管理-处理编辑', 'controller' => 'app',		'action' => 'doedit'),
        '3805' => array("show"=>0,'name' => 'APP管理-删除', 'controller' => 'app',		'action' => 'del'),
        //'39' => array("show"=>1,'name' => 'URL推送', 'controller' => 'sitesend',      'action' => 'index'),
    )),
    ...
    '7' => array('name' => lang('menu/templates'), 'icon' => 'layui-icon-template', 'sub' => array(
        ...
        '7201' => array("show"=>0,'name' => '--模板信息维护', 'controller' => 'template',     'action' => 'info'),
        '7202' => array("show"=>0,'name' => '--模板删除', 'controller' => 'template',       'action' => 'del'),
