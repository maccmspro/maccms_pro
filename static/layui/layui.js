  ...
  (u.prototype.type = function () {
    ...
    (u.prototype.view = function () {
      ...
      (a.layout =
        ...
        (a.prev = "prev" in a ? a.prev : i18n_layui.page_prev||"&#x4E0A;&#x4E00;&#x9875;"),
        (a.next = "next" in a ? a.next : i18n_layui.page_next||"&#x4E0B;&#x4E00;&#x9875;");
      var n =
          a.pages > t
        ...
        i = {
          ...
          count:
            ...
            (i18n_layui.page_total||'\u5171 ') +
            a.count +
            (i18n_layui.page_num||" \u6761") + 
            "</span>",
          limit: (function () {
              ...
              layui.each(a.limits, function (t, n) {
                e.push(
                  '<option value="' +
                    ...
                    ">" +
                    n +
                    i18n_layui.page_perpage||" \u6761/\u9875"+"</option>"
                );
              }),
              e.join("") + "</select></span>"
            );
          ...
          skip: (function () {
            return [
              '<span class="layui-laypage-skip">'+(i18n_layui.page_go||'&#x5230;&#x7B2C;'),
              '<input type="text" min="1" value="' +
                a.curr +
                '" class="layui-input">',
                (i18n_layui.page_page||'&#x9875;')+
                '<button type="button" class="layui-laypage-btn">'+ (i18n_layui.page_ok||'&#x786e;&#x5b9a;') +'</button>',
              "</span>",
            ].join("");
          })(),
        };
    ...
    (p.prototype.upload = function (e, i) {
          ...
          layui.each(o, function (e, o) {
            ...
            var c = {
              ...
              error: function () {
                n++,
                  a.msg(
                    i18n_layui.upload_tip1||"\u8bf7\u6c42\u4e0a\u4f20\u63a5\u53e3\u51fa\u73b0\u5f02\u5e38"
                  ),
                  m(e),
                  u();
              },
          ...
          a.elemFile.parent().submit(),
            ...
            (p.timer = setInterval(function () {
              ...
              try {
                ...
                a.msg(
                  i18n_layui.upload_tip2||"\u83b7\u53d6\u4e0a\u4f20\u540e\u7684\u54cd\u5e94\u4fe1\u606f\u51fa\u73b0\u5f02\u5e38"
                ),
                  clearInterval(p.timer),
                  m();
              }
          ...
          if (
            ...
            try {
              ...
              return (
                (t = {}),
                a.msg(
                  i18n_layui.upload_tip3||"\u8bf7\u5bf9\u4e0a\u4f20\u63a5\u53e3\u8fd4\u56de\u6709\u6548JSON"
                )
              );
            }
      ...
      if (
        ...
        switch (l.accept) {
          case "file":
            if (h && !RegExp("\\w\\.(" + h + ")$", "i").test(escape(v)))
              return (
                a.msg(
                  i18n_layui.upload_tip4||"\u9009\u62e9\u7684\u6587\u4ef6\u4e2d\u5305\u542b\u4e0d\u652f\u6301\u7684\u683c\u5f0f"
                ),
                (r.value = "")
              );
            break;
          case "video":
            if (
              ...
              return (
                a.msg(
                  i18n_layui.upload_tip5||"\u9009\u62e9\u7684\u89c6\u9891\u4e2d\u5305\u542b\u4e0d\u652f\u6301\u7684\u683c\u5f0f"
                ),
                (r.value = "")
              );
            break;
          case "audio":
            if (
              ...
              return (
                a.msg(
                  i18n_layui.upload_tip6||"\u9009\u62e9\u7684\u97f3\u9891\u4e2d\u5305\u542b\u4e0d\u652f\u6301\u7684\u683c\u5f0f"
                ),
                (r.value = "")
              );
            break;
          default:
            if (
              ...
              return (
                a.msg(
                  i18n_layui.upload_tip7||"\u9009\u62e9\u7684\u56fe\u7247\u4e2d\u5305\u542b\u4e0d\u652f\u6301\u7684\u683c\u5f0f"
                ),
                (r.value = "")
              );
        }
        if (
          ...
          return a.msg(
            i18n_layui.upload_tip8||"\u540c\u65f6\u6700\u591a\u53ea\u80fd\u4e0a\u4f20\u7684\u6570\u91cf\u4e3a\uff1a" +
              l.number
          );
        if (l.size > 0 && !(o.ie && o.ie < 10)) {
          ...
          if (
            ...
            return a.msg(i18n_layui.upload_tip9||"\u6587\u4ef6\u4e0d\u80fd\u8d85\u8fc7" + F);
        }
        y();
      }
    }),
        ...
        l = function (t, n) {
          var o = e.elemFile,
            a =
              ...
              t.length > 1
                ? t.length + i18n_layui.upload_tip10||"\u4e2a\u6587\u4ef6"
                : (t[0] || {}).name ||
                  o[0].value.match(/[^\/\\]+\..+/g) ||
                  [] ||
                  "");
