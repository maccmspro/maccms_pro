...
class Update extends Base
{
    ...
    public function __construct()
    {
        ...
        $this->_url = base64_decode("aHR0cHM6Ly91cGRhdGUubWFjY21zLnByby8=")."pro/";
    ...
    public function step1($file='')
    {
        ...
        echo "<div class='update'><h1>".lang('admin/update/step1_a')."</h1><textarea rows=\"15\" class='layui-textarea' readonly>".lang('admin/update/step1_b')."\n";
        ob_flush();flush();
        sleep(1);
    ...
    public function step2()
    {
        ...
        echo $this->fetch('admin@public/head');
        echo "<div class='update'><h1>".lang('admin/update/step2_a')."</h1><textarea rows=\"15\" class='layui-textarea' readonly>\n";
        ob_flush();flush();
        sleep(1);
    ...
    {
        echo $this->fetch('admin@public/head');
        echo "<div class='update'><h1>".lang('admin/update/step3_a')."</h1><textarea rows=\"15\" class='layui-textarea' readonly>\n";
        ob_flush();flush();
        sleep(1);
