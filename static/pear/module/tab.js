layui.define(['jquery', 'element'], function(exports) {
	...
	pearTab.prototype.render = function(opt) {
		...
		$("body .layui-tab[lay-filter='" + option.elem + "']").on("contextmenu", "li", function(e) {
			...
			var menu = "<ul><li class='item' id='" + option.elem + "closeThis'>" + cur + "</li><li class='item' id='" + option.elem +
				"closeOther'>" + other + "</li><li class='item' id='" + option.elem + "closeAll'>" + all + "</li></ul>";
	...
	function createTab(option) {
		...
		title += '</ul>';
		content += '</div>';
		control += '<dd id="closeThis"><a href="#">' + cur + '</a></dd>'
		control += '<dd id="closeOther"><a href="#">' + other + '</a></dd>'
		control += '<dd id="closeAll"><a href="#">' + all + '</a></dd>'
