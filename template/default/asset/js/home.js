...
var MAC={
        ...
        'Submit':function(){
            ...
            MAC.Ajax(maccms.base_url + '/index.php/gbook/saveData','post','json',$('.gbook_form').serialize(),function(r){
                ...
                if(r.code == 1){
                    ...
                    if(r.code==1002){
                        let timeStr=$('.comm-code').attr('onClick').split('?v=')[1]
                        let time=timeStr.substring(0,timeStr.length-1)
                        let src='http://'+location.host+$('.comm-code').attr('data-role')+ '?v='+ time
                        $('.comm-code').attr('src',src)
                    }
                }
            });
        },
    ...
    'User':{
        ...
        'Init':function(){
            ...
            if($('.mac_user').length >0 && clientWidth>820){
            ...
            if(MAC.Cookie.Get('user_id') !=undefined && MAC.Cookie.Get('user_id')!=''){
                ...
                if($('.mac_user').length >0) {
                    ...
                    html += '<div class="user_list_box"><div class="user_list"><a class="mac_user_n" href="javascript:;">'+UName+'</a><a class="mac_user_g" href="javascript:;">' + GName + '</a><a class="link" href="' + url + '" target="_blank"><i class="iconfont">&#xe62b;</i> <span data-lang="string_user_center">个人中心</span> </a><a class="link" href="' + urlfavs + '" target="_blank"><i class="iconfont">&#xe629;</i>  <span data-lang="string_user_fav">我的收藏</span></a><a class="link" href="javascript:;" onclick="MAC.User.Logout();" target="_self"><i class="iconfont">&#xe646;</i><span data-lang="string_user_logout">退出登录</span></a></div></div>'
        ...
        'Login':function(){
            ...
            MAC.Pop.Show(400,380, lang==1?'User Login':'用户登录',maccms.base_url+'/index.php/user/'+ac,function(r){
