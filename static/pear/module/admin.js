	...
	function(exports) {
		...
		body.on("click", ".setting", function() {
			...
			layer.open({
				...
				move: false,
				content: html + buildColorHtml() + buildLanguageHtml() + buildLinkHtml() + bottomTool(),
				success: function(layero, index) {
					...
					$('.lang-select').change(function(evt){
		...
		function buildColorHtml() {
			...
			return "<div class='select-color'><div class='select-color-title'>" + title + "</div><div class='select-color-content'>" +
				colors + "</div></div>"
		}
		// 多语言选项
		function buildLanguageHtml() {
			...
			return "<div class='select-color'><div class='select-color-title'>" + title + "</div><select class='lang-select' name='lang' lay-filter='lang'>" +
