layui.define(["jquery","layer"], function (exports) {
	...
	theme.colorSet = function(color) {
		...
		style += '.layui-laypage a:hover{color:'+color+'!important}'
		style += '.layui-laypage input:focus, .layui-laypage select:focus{border-color:'+color+'!important}'
		style += '.layui-badge{background-color:'+color+'!important}'
		style += '.layui-laypage-limits select option:hover{background-color:'+color+'!important}'
		style += '.layui-laypage-limits select option.selected{background-color:'+color+'!important}'
		style += '.layui-btn{background-color:'+color+'!important}'
		style += '.layui-tab-brief>.layui-tab-title .layui-this{color:'+color+'!important}'
